...
print('Vitej v teto sigmicke kalkulacce kterou vytvoril ten sigmus Tomandes (dej odbera) !')
print('Umim scitat, odcitat, delit a nasobit cisla od 0 do 50')
num1 = int(input('Vyber svoje prvni SIGMICKE cislo: '))
sign = input('+, -, /, nebo *: ')
num2 = int(input('Vyber druhy cislo: '))
...
print("dik ze ses takova SIGMA a pouzil si tuto kalkulacku")